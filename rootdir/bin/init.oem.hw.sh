...
if [ ! -z "$mount_2nd_stage" ]; then
	debug "Super image detection"
	[ -f /vendor/firmware_mnt/super_modem ] && setprop ro.vendor.hw.modem_super_image yes
	[ -f /vendor/fsg/super_modem ] && setprop ro.vendor.hw.fsg_super_image yes
	return 0
fi
